...
//const settingsFieldNames = ["colNumber", "rowToWin", "playerSign1", "playerSign2"];
    ...
    return (
        <Container className="d-flex justify-content-around align-items-center flex-column" style={{height: "80vh"}}>
                ...
                <div className = "d-flex gap-1 flex-column align-items-center">
                    ...
                    <ButtonGroup>
                        <Link className="d-flex justify-content-between align-items-center px-3 gap-1 game-menu">
